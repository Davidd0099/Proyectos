...
<body>
	...
	<div class="manageproveedor">
		<a href="create.php"><button type="button" class="btn-success">Añadir proveedor</button></a>
		<table border="1" cellspacing="0" cellpadding="0" style="border-color: black">
			<thead>
				<tr>
					<th>Id</th>
					<th>Nombre</th>
				...
				if ($result->num_rows > 0) {
					while ($row = $result->fetch_assoc()) {
						...
						<td>
							...
							<a href='remove.php?idprov=" . $row['idprov'] . "'><button type='button' class='btn-success'><img src='img/eliminar.png' width='30' height='30' title='eliminar proveedor'></button></a>
						</td>
					</tr>";
					}
				} else {
