...
<body>
	...
	<fieldset class="manageproveedor">
		<legend style="color: white">AÑADIR PROVEEDOR</legend>
		...
		<form action="php_action/create.php" method="post">
			<table cellspacing="0" cellpadding="0">
				...
				<tr>
					<th>Ciudad</th>
					<td><select class="form-control" name="idciu1" required>
				...
				<tr>
					<td><button type="submit" class="btn-success">Guardar cambios</button></td>
					<td><a href="proveedor.php"><button type="button" class="btn-danger">Atras</button></a></td>
				</tr>
			</table>
		</form>
