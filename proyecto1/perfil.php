...
<div class="container">
    ...
    $resultado = $mysqli->query("SELECT * FROM producto ORDER BY idpro");
                            		...
                            		<tr>
                            			...
                            			<td>
                            				<div class="col">
                                  			...
                                  			<?php 
                                    			if($_SESSION["rolcli"] == "admin"){
                                        			echo "<a width='40' href='perfil.php?idpro=" . $fila['idpro'] ."' class='btn btn-danger btn-block'><img src='img/eliminar.png' width='30' height='30' title='eliminar producto'></a>";   
                                    			}
