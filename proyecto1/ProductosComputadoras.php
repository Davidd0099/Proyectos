...
<div class="container">
    ...
    $resultado = $mysqli->query("SELECT * FROM producto where idslpro1 between 11 and 15 ORDER BY idslpro1");
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col">
                                                <?php 
                                                    echo "<a width='40' href='ProductosComputadoras.php?idpro1=" . $fila['idpro'] ."' class='btn btn-success btn-block'>Añadir al carrito</a>";
                                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php 
                                                if($_SESSION["rolcli"] == "admin"){
                                                    echo "<a width='40' href='ProductosComputadoras.php?idpro=" . $fila['idpro'] ."' class='btn btn-danger btn-block'><img src='img/eliminar.png' width='30' height='30' title='eliminar producto'></a>";   
                                                }
                                            ?>   
                                </div>
                                        </td>
