...
$mysqli->real_query("SELECT * FROM sublineadeproducto where desslpro = '$sub'");
    ...
    $mysqli->query("update producto set nombrePro='$name', imagenes='$img', canpro = '$can', despro='$des', vlrpro='$pay', idprov1='$prov', idslpro1='$sub1' where idpro = '$id'");
...
$mysqli->real_query("SELECT * FROM proveedor where nomprov = '$prov'");
    ...
    $mysqli->query("update producto set nombrePro='$name', canpro = '$can', despro='$des', vlrpro='$pay',  idprov1='$prov1', idslpro1='$sub1' where idpro = '$id'");
