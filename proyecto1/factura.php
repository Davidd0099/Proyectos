            ...
            <address>
              ...
              <?php
                    ...
                    while ($fila1 = $resultado1->fetch_assoc()) {
                      $ciudad_nac1 = $fila1['nomciu'];
                    }
              ?>
              <?php echo $ciudad_nac1; ?><br>
            </address>
          </div>
        </div>
        <div class="row">
...
$total = 0;
        ...
        <div class="totals">
          <div class="totals-item">
            ...
            <div class="totals-value" id="cart-subtotal" style=""><?php echo $total;?></div>
          </div>
          <div class="totals-item">
          ...
          <form action="pagar.php" method="post">
            <div class="totals-item totals-item-total">
              ...
              <div class="totals-value" id="cart-total" name="cart-total" style=""><?php echo $total;?></div>
            </div>
        </div>
