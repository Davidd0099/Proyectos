...
session_start();
    $mysqli = new mysqli("localhost", "root", "", "proyecto");
          ...
          //$mysqli->query("SELECT * FROM empleado where id = '".$_GET["id"]."'");
            ...
            $mysqli->real_query("SELECT * FROM usuario where idusu = '".$_GET["idusu"]."'"); 
    ...
    <div id="login-box">
       ...
       <form action="saveusuarios.php" method="POST">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <select class="form-control" style="width: 85%" required name="sexo">
                                          <option value="">Elija sexo</option>
                                           <option value="" value="masculino">Masculino</option>
                   ...
                   $mysqli = new mysqli("localhost", "root", "", "proyecto");
                         ...
                         $mysqli->real_query("SELECT * FROM tipoidentificacion where idtide = '$tipo'");
                         $resultado = $mysqli->use_result();
                         ...
                         ?>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control"   name="numero_doc" value="<?php echo"$numero_doc"  ?>"  required>
                                    </div>
                                </div>
                   ...
                   $mysqli = new mysqli("localhost", "root", "", "proyecto");
                         ...
                         $mysqli->real_query("SELECT * FROM ciudad where idciu = '$ciudad_nac'");
                         $resultado = $mysqli->use_result();
                         ...
                         ?>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control" min="1000000000" max="9999999999" name="telefono" value="<?php echo"$telefono"  ?>" required>
                                    </div>
                                </div>
                   ...
                   $mysqli = new mysqli("localhost", "root", "", "proyecto");
                         ...
                         $mysqli->real_query("SELECT * FROM ciudad where idciu = '$ciudad_de_res'");
                         $resultado = $mysqli->use_result();
