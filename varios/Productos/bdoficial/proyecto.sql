...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-09-2019 a las 08:50:38
...
CREATE TABLE `cliente` (
  ...
  `emacli` char(200) NOT NULL,
  `concli` char(100) NOT NULL,
...
INSERT INTO `cliente` (`idcli`, `idtide1`, `nomcli`, `apecli`, `gencli`, `fnaccli`, `dircli`, `telcli`, `emacli`, `concli`, `idciu2`, `rolcli`) VALUES
('1', '1', 'Dan ', 'Arias', 'm', '0000-00-00', 'calle 16', '3152319383', 'daniel@hotmail.com', '123456', '1', 'admin'),
('2', '1', 'Edgar', 'Edgar', 'm', '0000-00-00', 'calle 15', '3211234455', 'edgar@hotmail.com', '123456', '2', 'usuario');
...
INSERT INTO `producto` (`idpro`, `idslpro1`, `despro`, `vlrpro`, `cancompro1`, `canpro`, `ivapro`, `idprov1`) VALUES
('1', '1', 'TV panasonic 21313 pulgadas', 1.00, NULL, NULL, NULL, NULL),
('10', '9', 'smartphone con deficit de \"smart\"', 22.00, NULL, NULL, NULL, NULL),
('11', '11', 'pc gamer samsung no c xd', 12.00, NULL, NULL, NULL, NULL),
('12', '12', 'pc lenovo aunque no puse lenovo en proveedor', 12.00, NULL, NULL, NULL, NULL),
('13', '12', 'pc dinosaurio', 23.00, NULL, NULL, NULL, NULL),
('14', '12', 'pc samsung, no se si existan', 23.00, NULL, NULL, NULL, NULL),
('15', '11', 'computador casi nuevo con dos teclas malas pero sirven si le hace duro', 5.00, NULL, NULL, NULL, NULL),
('16', '16', 'noentiendo switch', 5.00, NULL, NULL, NULL, NULL),
('17', '17', 'wii u en 2019 juasjuas', 2.00, NULL, NULL, NULL, NULL),
('18', '16', 'xbox 31231241', 32.00, NULL, NULL, NULL, NULL),
('19', '18', 'ps23 slim', 43.00, NULL, NULL, NULL, NULL),
('2', '1', 'tv para pobres v5', 23.00, NULL, NULL, NULL, NULL),
('20', '19', 'gameboy color', 12.00, NULL, NULL, NULL, NULL),
('21', '21', 'equipo de sonido que suena', 43.00, NULL, NULL, NULL, NULL),
('22', '22', 'boom boom boom', 12.00, NULL, NULL, NULL, NULL),
('23', '23', 'este equipo solo reproduce canciones de coldplay', 0.00, NULL, NULL, NULL, NULL),
('24', '21', 'minicomponente, pero no tan peque¤o como su interes por ti', 2.00, NULL, NULL, NULL, NULL),
('25', '22', 'equipo sony', 3.00, NULL, NULL, NULL, NULL),
('3', '1', 'tv para ricos equisde', 43.00, NULL, NULL, NULL, NULL),
('4', '1', 'tv plasma en 2019', 2.00, NULL, NULL, NULL, NULL),
('5', '1', 'televisor equis', 5.00, NULL, NULL, NULL, NULL),
('6', '6', 'telefono sony con windows phone juasjuas', 20.00, NULL, NULL, NULL, NULL),
('7', '7', 'el de arriba es gay (smartphone)', 43.00, NULL, NULL, NULL, NULL),
('8', '8', 'celular de chris pane', 12.00, NULL, NULL, NULL, NULL),
('9', '7', 'celular de alguien que no es chris pane', 32.00, NULL, NULL, NULL, NULL);
...
-- Error leyendo datos de la tabla proyecto.sublineadeproducto: #1064 - Algo está equivocado en su sintax cerca 'FROM `proyecto`.`sublineadeproducto`' en la linea 1
