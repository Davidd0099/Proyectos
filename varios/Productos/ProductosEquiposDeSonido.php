...
<body class="top-header">
    ...
    <div class="tcat">
		<center>
			<table border="1">
				<tr>
					<td colspan="3"><center><img src="img/sonido.png" height="200" width="200"></center></td>
					
				</tr>
				<tr>
					<th style="text-align: center" colspan="3">EQUIPOS DE SONIDO</th>
				                </tr>
                 <tr>
                    <td >
                           <table border="1">
        ...
        <?php
           ...
           while ($fila = $resultado->fetch_assoc()) {
                if (($fila['idslpro1'] > 20) && ($fila['idslpro1'] < 26)) {
                    # code...
