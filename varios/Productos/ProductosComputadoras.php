...
<body class="top-header">
    ...
    <div class="tcat">
        <center>
            <table border="1">
                <tr>
                    <td colspan="3"><center> <img src="img/pc.png" height="200" width="200" ></center> </td>
                </tr>
                <tr>
                    <th style="text-align: center" colspan="3">COMPUTADORAS</th>
                </tr>
                 <tr>
                    <td >
                           <table border="1">
        ...
        <?php
           ...
           while ($fila = $resultado->fetch_assoc()) {
                if (($fila['idslpro1'] > 10) && ($fila['idslpro1'] < 16)) {
                    # code...
...
//id    nompro  vlrpro  canpro  ivapro  idprov1 est_pro idslpro despro
                ...
                echo "</td>";
                        ...
                        if($_SESSION["rolcli"] == "admin"){
                            ...
                            echo "<button><a href='ProductosComputadoras.php?idpro=" . $fila['idpro'] ."' ><img src='img/eliminar.png' width='30' height='30' title='eliminar producto'></button></td>";
                        }else{
                            echo "</td>";
                        }
...
<!-- if($_SESSION["rol"] == "admin"){
                             echo "<a href='editar_producto.php'><button>editar</button></a>";
