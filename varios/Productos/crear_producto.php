                            ...
                            <center>
                                <form action="insertarproducto.php" method="POST">
                                    ...
                                    <table border="1">
                                        ...
                                        <tr>
                                            <td>Ingrese la ID del producto: </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="cantidad" required="true" min="0"></td>
                                        </tr>
                                        <tr>
                                            <td>Digite el iva: </td>
                                            <td><input type="number" name="iva" required="true"></td>
                                        </tr>
                                        <tr>
                                            <td>Digite la id del proveedor: </td>
                                            <td><input type="number" name="proveedor" required="true"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="2" style="position: middle">
                                                <center><input type="submit" value="Insertar datos"></center>
                                            </td>
                                        </tr>
