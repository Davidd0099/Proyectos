...
<head>
 ...
 <!-- tabla producto CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="css/est_cli.css">
...
<body class="top-header">
    <input type="hidden" name="sesion" value=" <?php echo $_SESSION; ?> ">
    <!-- LOADER TEMPLATE -->
    <div id="page-loader">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary main-nav navbar-togglable">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item">
                            <a href="\Productos\Proveedor\index.php" class="nav-link">
                                Proveedores
                            </a>
                        </li>
                        <li class="nav-item ">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 text-center">
                    <div class="section-heading">
                        ...
                        <!-- Subheading -->
                       <div class="tcrud" style="width: 100%">
        <center>
            <table class="tbcrud" border="1">
                <tr>
                    <td colspan="5" class="tdcrud">
                        categorias
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <center> <a href="ProductosMoviles.php"> <img src="img/moviles.png" width="70" height="70"> </a> </center>
                    </td>
                    <td>
                        <center> <a href="ProductosSmartTvs.php"> <img src="img/smarttv.png" width="70" height="70"> </a> </center>
                    </td>
                    <td>
                        <center> <a href="ProductosComputadoras.php"> <img src="img/pc.png" width="70" height="70"> </a> </center>
                    </td>
                    <td>
                         <center> <a href="ProductosEquiposDeSonido.php"> <img src="img/sonido.png" width="70" height="70"> </a> </center>
                    </td>
                    <td>
                        <center> <a href="ProductosConsolas.php"> <img src="img/consolas.png" width="70" height="70"> </a> </center>
                    </td>
                </tr>
            </table>
