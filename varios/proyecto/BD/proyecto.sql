...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-09-2019 a las 21:56:51
...
CREATE TABLE `factura` (
  ...
  `idpro1` int(11) DEFAULT NULL,
  `idusu3` int(11) DEFAULT NULL,
  `facmet` varchar(50) DEFAULT NULL,
  `faccan` double(12,2) DEFAULT NULL,
  `faciva1` int(11) DEFAULT NULL,
  `factot` double(12,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `iva` (
  ...
  `caniva` double(20,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `iva` (`idiva`, `caniva`) VALUES
(1, 0.00),
(2, 5.00),
(3, 19.00);
...
(32, 'Panasonic tv', 1, 'TV panasonic 21313 pulgadas', '', 124124.00, 0, 100.00, 0, 2),
(33, 'Barato Barato', 1, 'tv para pobres v5', '', 1214.00, 0, 100.00, 0, 4),
(34, 'Caro caro', 1, 'tv para ricos equisde', '', 124.00, 0, 100.00, 0, 2),
(35, 'Plasma', 1, 'tv plasma en 2019', '', 5112.00, 0, 100.00, 0, 2),
(36, 'TV X', 1, 'televisor equis', '', 362.00, 0, 100.00, 0, 1),
(37, 'Sony Xperia 6', 6, 'telefono sony con windows phone juasjuas', '', 23523.00, 0, 100.00, 0, 5),
(38, 'Gay stuff', 7, 'el de arriba es gay (smartphone)', '', 131.00, 0, 100.00, 0, 4),
(39, 'CeluPane', 8, 'celular de chris pane', '', 0.00, 100, 123.00, 0, 4),
(40, 'Ni lo compres', 7, 'celular de alguien que no es chris pane', '', 0.00, 0, 100.00, 0, 3),
(41, 'DumbPhone', 9, 'smartphone con deficit de \"smart\"', '', 5685.00, 0, 100.00, 0, 5),
(42, 'Samsung PC x900', 11, 'pc gamer samsung no c xd', '', 4646.00, 0, 100.00, 0, 1),
(43, 'Lenovo PT 123', 12, 'pc lenovo aunque no puse lenovo en proveedor', '', 999.00, 0, 100.00, 0, 4),
(44, 'T-rex PC', 12, 'pc dinosaurio', '', 231231.00, 0, 100.00, 0, 2),
(45, 'Samsung no gamer', 12, 'pc samsung, no se si existan', '', 235.00, 0, 100.00, 0, 1),
(46, 'PC anonimo', 11, 'computador casi nuevo con dos teclas malas pero sirven si le hace duro', '', 99.00, 100, 123.00, 0, 4),
(47, 'Nintendo Switch', 16, 'noentiendo switch', '', 99999.00, 0, 100.00, 0, 3),
(48, 'Wii U', 17, 'wii u en 2019 juasjuas', '', 0.00, 0, 100.00, 0, 2),
(49, 'XBOX 36666', 19, 'xbox 31231241', '', 12412.00, 0, 100.00, 1, 1),
(50, 'Playstation', 18, 'ps23 slim', '', 124.00, 0, 100.00, 0, 1),
(51, 'Gameboy', 19, 'gameboy color', '', 1532.00, 0, 100.00, 0, 2),
(52, 'Sound Stuff', 21, 'equipo de sonido que suena', '', 999.00, 0, 100.00, 0, 4),
(53, 'BEP', 22, 'boom boom boom', '', 666.00, 0, 100.00, 0, 1),
(54, 'Coldplay sound maker', 23, 'este equipo solo reproduce canciones de coldplay', '', 99999.00, 0, 100.00, 0, 4),
(55, 'Mini samsung sound', 21, 'minicomponente, pero no tan peque¤o como su interes por ti', '', 12.00, 0, 100.00, 0, 2),
(56, 'Sony master sound', 22, 'equipo sony', '', 6657.00, 0, 100.00, 0, 2),
(67, 'KOALA', 18, 'No es electrÃ³nico, pero es bonito', 'http://localhost/proyecto/img2/Koala.jpg', 99999.00, NULL, 1.00, 3, 0);
...
(4, 'enrique', 'lozano', 'Elija sexo', 2, '123456743534', 1, '2019-09-01', '4356785678', 1, 'av5eoste44a11', 'enrique@hotmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'cliente'),
(7, 'Dan', 'Arias', 'masculino', 1, '1005123421', 1, '2000-08-18', '3151234422', 1, 'calle 12 # 12-32 (sena)', 'daniel@hotmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'admin');
...
ALTER TABLE `factura`
  ...
  ADD KEY `idpro1` (`idpro1`),
  ADD KEY `idusu3` (`idusu3`),
  ADD KEY `faciva1` (`faciva1`);
...
--
ALTER TABLE `lineaproducto`
  MODIFY `idlpro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `producto`
--
ALTER TABLE `producto`
  MODIFY `idpro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `sublineadeproducto`
  MODIFY `idslpro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de la tabla `tipoidentificacion`
--
ALTER TABLE `tipoidentificacion`
  MODIFY `idtide` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `factura`
  ADD CONSTRAINT `factura_ibfk_1` FOREIGN KEY (`idpro1`) REFERENCES `producto` (`idpro`),
  ADD CONSTRAINT `factura_ibfk_2` FOREIGN KEY (`idusu3`) REFERENCES `usuario` (`idusu`),
  ADD CONSTRAINT `factura_ibfk_3` FOREIGN KEY (`faciva1`) REFERENCES `producto` (`ivapro`);
