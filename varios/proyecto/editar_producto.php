                    ...
                    <div class="section-heading">
                        ...
                        <div class="tcrud">
                            <center>
                                ...
                                ?>
                                <form enctype="multipart/form-data" action="coneditarproducto.php" method="POST">
                                    <table border="2" bgcolor="#292A39" style="border-color: black">
                                        ...
                                        <tr>
                                            <td>Imagen actual: </td>
                                            <td>
                                                <center><img width="250" height="250" src="<?php echo $img ?>"></center>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Seleccione imagen nueva: </td>
                                        ...
                                        <tr>
                                            <td>Descripción: </td>
                                            <td><input type="text" name="descripcion" required="true" value="<?php echo $des ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Valor: </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><select name="iva" required="true">
                                                    ...
                                                    $mysqli->real_query("SELECT * FROM iva where idiva = '$iva'");
                                                    $resultado = $mysqli->use_result();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="proveedor" required="true">
                                                    ...
                                                    $mysqli->real_query("SELECT * FROM proveedor where idprov = '$prov'");
                                                    $resultado = $mysqli->use_result();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="sublinea" required="true">
                                                    ...
                                                    $mysqli->real_query("SELECT * FROM sublineadeproducto where idslpro = '$sub'");
                                                    $resultado = $mysqli->use_result();
                                        ...
                                        <tr>
                                            <td colspan="2" style="position: middle"><br>
                                                <center><input type="submit" value="Actualizar datos"></center><br>
                                            </td>
                                        </tr>
