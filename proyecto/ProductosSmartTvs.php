        ...
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Smartv</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="container">
    ...
    $resultado = $mysqli->query("SELECT * FROM producto where idslpro1 between 1 and 5 ORDER BY idslpro1");
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col">
                                                <?php 
                                                    echo "<a width='40' href='ProductosSmartTvs.php?idpro1=" . $fila['idpro'] ."' class='btn btn-success btn-block'>Añadir al carrito</a>";
                                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php 
                                                if($_SESSION["rolcli"] == "admin"){
                                                    echo "<a width='40' href='ProductosSmartTvs.php?idpro=" . $fila['idpro'] ."' class='btn btn-danger btn-block'><img src='img/eliminar.png' width='30' height='30' title='eliminar producto'></a>";   
                                                }
                                            ?>   
                                </div>
                                        </td>
