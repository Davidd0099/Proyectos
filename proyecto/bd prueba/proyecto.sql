...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-09-2019 a las 16:44:42
...
INSERT INTO `ciudad` (`codciu`, `coddep`, `nomciu`) VALUES
(1, 5, 'MEDELLIN'),
(1, 8, 'BARRANQUILLA'),
(1, 11, 'BOGOTA, D.C.'),
(1, 13, 'CARTAGENA'),
...
CREATE TABLE `producto` (
  ...
  `canpro` int(11) DEFAULT NULL,
  `ivapro` double(12,2) DEFAULT NULL,
  `idprov1` char(11) DEFAULT NULL,
  `est_pro` char(1) NOT NULL,
  `idslpro` char(11) DEFAULT NULL,
...
INSERT INTO `producto` (`id`, `nompro`, `vlrpro`, `canpro`, `ivapro`, `idprov1`, `est_pro`, `idslpro`, `despro`) VALUES
(1, 'telefono LG 6755765 pulgadas', 999999999.00, 700, 1298.00, '7', '6', '7', '1%'),
(3, 'pcgamer x600 lenovo pro', 3465123781.00, 8798, 131.00, '7', '1', '13', '34%'),
(4, 'switch', 2310891.00, 8677, 80913.00, '21', '1', '20', '23%'),
(5, 'tv sony 13123 pulgaditas papá', 123123123.00, 123123, 123123.00, '2', '1', '4', '312314%'),
(6, 'equipos de sonido equis', 1.00, 1, 0.00, '1', '1', '22', '1%');
...
CREATE TABLE `sublineaproducto` (
  ...
  `desslpro` varchar(400) DEFAULT NULL,
  `idlpro` char(11) DEFAULT NULL,
...
INSERT INTO `sublineaproducto` (`idslpro`, `desslpro`, `idlpro`, `est_pro`) VALUES
(1, 'smart tv', '1', '1'),
(2, 'tv 4k', '1', '1'),
(3, 'tv led', '1', '1'),
(4, 'tv 3D', '1', '1'),
(5, 'tv LCD', '1', '1'),
(6, 'smartphone', '1', '2'),
(7, 'telefono clasico', '1', '2'),
(8, 'telefono low cost', '1', '2'),
(9, 'telefono gama alta', '1', '2'),
(10, 'telefono gama media', '1', '2'),
(11, 'pc gamer', '1', '3'),
(12, 'pc portatil', '1', '3'),
(13, 'pc trabajo', '1', '3'),
(14, 'pc uso educativo', '1', '3'),
(15, 'pc mini portatil', '1', '3'),
(16, 'consola realidad virtual', '1', '4'),
(17, 'consola arcade', '1', '4'),
(18, 'consola portatil', '1', '4'),
(19, 'consola escritorio', '1', '4'),
(20, 'consola interactiva', '1', '4'),
(21, 'teatro en casa', '1', '5'),
(22, 'minocomponente', '1', '5'),
(23, 'equipo ulta', '1', '5'),
(24, 'equipo de sonido de escritorio', '1', '5'),
(25, 'altavoces', '1', '5');
...
(1, 'daniel', 'daniel@hotmail.com', '123456', 'admin'),
(2, 'enrique', 'enrique@hotmail.com', '123456', 'admin'),
(3, 'adgar', 'edgar@hotmail.com', '123456', 'client');
